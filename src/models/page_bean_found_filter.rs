...
/// PageBeanFoundFilter : A page of items.

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct PageBeanFoundFilter {
    /// The URL of the page.
    ...
    pub values: Option<Vec<crate::models::FoundFilter>>,
}

impl PageBeanFoundFilter {
    /// A page of items.
    pub fn new() -> PageBeanFoundFilter {
        PageBeanFoundFilter {
            _self: None,
            next_page: None,
            max_results: None,
