...
------------- | ------------- | -------------
[**add_comment_post**](IssueCommentsApi.md#add_comment_post) | **post** /rest/api/3/issue/{issueIdOrKey}/comment | Add comment
...
[**get_comments_by_ids_post**](IssueCommentsApi.md#get_comments_by_ids_post) | **post** /rest/api/3/comment/list | Get comments by IDs
[**update_comment_put**](IssueCommentsApi.md#update_comment_put) | **put** /rest/api/3/issue/{issueIdOrKey}/comment/{id} | Update comment



## add_comment_post

> crate::models::Comment add_comment_post(issue_id_or_key, request_body, expand)
Add comment
...
## get_comments_by_ids_post

> crate::models::PageBeanComment get_comments_by_ids_post(issue_comment_list_request_bean, expand)
Get comments by IDs
...
> crate::models::Comment update_comment_put(issue_id_or_key, id, request_body, expand)
Update comment
