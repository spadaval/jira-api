...
[**set_project_property_put**](ProjectPropertiesApi.md#set_project_property_put) | **put** /rest/api/3/project/{projectIdOrKey}/properties/{propertyKey} | Set project property
...
## set_project_property_put

> serde_json::Value set_project_property_put(project_id_or_key, property_key, body)
