...
------------- | ------------- | -------------
[**create_or_update_remote_issue_link_post**](IssueRemoteLinksApi.md#create_or_update_remote_issue_link_post) | **post** /rest/api/3/issue/{issueIdOrKey}/remotelink | Create or update remote issue link
...
[**update_remote_issue_link_put**](IssueRemoteLinksApi.md#update_remote_issue_link_put) | **put** /rest/api/3/issue/{issueIdOrKey}/remotelink/{linkId} | Update remote issue link by ID



## create_or_update_remote_issue_link_post

> crate::models::RemoteIssueLinkIdentifies create_or_update_remote_issue_link_post(issue_id_or_key, request_body)
...
## update_remote_issue_link_put

> serde_json::Value update_remote_issue_link_put(issue_id_or_key, link_id, request_body)
