...
------------- | ------------- | -------------
[**add_vote_post**](IssueVotesApi.md#add_vote_post) | **post** /rest/api/3/issue/{issueIdOrKey}/votes | Add vote
[**get_votes**](IssueVotesApi.md#get_votes) | **get** /rest/api/3/issue/{issueIdOrKey}/votes | Get votes
[**remove_vote_delete**](IssueVotesApi.md#remove_vote_delete) | **delete** /rest/api/3/issue/{issueIdOrKey}/votes | Delete vote



## add_vote_post

> serde_json::Value add_vote_post(issue_id_or_key)
Add vote
...
> remove_vote_delete(issue_id_or_key)
Delete vote
