...
[**set_application_property_put**](JiraSettingsApi.md#set_application_property_put) | **put** /rest/api/3/application-properties/{id} | Set application property
...
## set_application_property_put

> crate::models::ApplicationProperty set_application_property_put(id, simple_application_property_bean)
