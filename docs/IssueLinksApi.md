...
[**link_issues_post**](IssueLinksApi.md#link_issues_post) | **post** /rest/api/3/issueLink | Create issue link
...
> serde_json::Value link_issues_post(link_issue_request_json_bean)
Create issue link
