...
[**set_comment_property_put**](IssueCommentPropertiesApi.md#set_comment_property_put) | **put** /rest/api/3/comment/{commentId}/properties/{propertyKey} | Set comment property
...
## set_comment_property_put

> serde_json::Value set_comment_property_put(comment_id, property_key, body)
