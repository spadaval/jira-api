...
[**set_worklog_property_put**](IssueWorklogPropertiesApi.md#set_worklog_property_put) | **put** /rest/api/3/issue/{issueIdOrKey}/worklog/{worklogId}/properties/{propertyKey} | Set worklog property
...
## set_worklog_property_put

> serde_json::Value set_worklog_property_put(issue_id_or_key, worklog_id, property_key, body)
