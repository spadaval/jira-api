...
------------- | ------------- | -------------
[**create_issue_link_type_post**](IssueLinkTypesApi.md#create_issue_link_type_post) | **post** /rest/api/3/issueLinkType | Create issue link type
...
[**update_issue_link_type_put**](IssueLinkTypesApi.md#update_issue_link_type_put) | **put** /rest/api/3/issueLinkType/{issueLinkTypeId} | Update issue link type



## create_issue_link_type_post

> crate::models::IssueLinkType create_issue_link_type_post(issue_link_type)
...
## update_issue_link_type_put

> crate::models::IssueLinkType update_issue_link_type_put(issue_link_type_id, issue_link_type)
