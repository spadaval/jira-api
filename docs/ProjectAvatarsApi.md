...
------------- | ------------- | -------------
[**create_project_avatar_post**](ProjectAvatarsApi.md#create_project_avatar_post) | **post** /rest/api/3/project/{projectIdOrKey}/avatar2 | Load project avatar
...
[**update_project_avatar_put**](ProjectAvatarsApi.md#update_project_avatar_put) | **put** /rest/api/3/project/{projectIdOrKey}/avatar | Set project avatar



## create_project_avatar_post

> crate::models::Avatar create_project_avatar_post(project_id_or_key, body, x, y, size)
Load project avatar
...
## update_project_avatar_put

> serde_json::Value update_project_avatar_put(project_id_or_key, avatar)
Set project avatar
